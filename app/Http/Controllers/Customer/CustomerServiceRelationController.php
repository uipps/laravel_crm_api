<?php
/**
 * CustomerServiceRelationController
 * @author dev@xhat.com
 * @since 2020-03-10
 */
...
use App\Services\Customer\CustomerServiceRelationService;


class CustomerServiceRelationController extends CommonController
{
    protected $theService;

    public function __construct() {
        $this->theService = new CustomerServiceRelationService();
        parent::__construct();
    }
