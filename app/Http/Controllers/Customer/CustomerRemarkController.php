...
use App\Services\Customer\CustomerRemarkService;


class CustomerRemarkController extends CommonController
{
    protected $theService;

    public function __construct() {
        $this->theService = new CustomerRemarkService();
        parent::__construct();
    }
