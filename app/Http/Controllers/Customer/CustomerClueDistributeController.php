<?php
/**
 * CustomerClueDistributeController
 * @author dev@xhat.com
 * @since 2020-03-10
 */
...
use App\Services\Customer\CustomerClueDistributeService;


class CustomerClueDistributeController extends CommonController
{
    protected $theService;

    public function __construct() {
        $this->theService = new CustomerClueDistributeService();
        parent::__construct();
    }
