...
use App\Services\Customer\CustomerClueProcessService;


class CustomerClueProcessController extends CommonController
{
    protected $theService;

    public function __construct() {
        $this->theService = new CustomerClueProcessService();
        parent::__construct();
    }
