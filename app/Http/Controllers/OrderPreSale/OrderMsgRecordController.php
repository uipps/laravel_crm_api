...
use App\Services\OrderPreSale\OrderMsgRecordService;


class OrderMsgRecordController extends CommonController
{
    protected $theService;

    public function __construct() {
        $this->theService = new OrderMsgRecordService();
        parent::__construct();
    }
