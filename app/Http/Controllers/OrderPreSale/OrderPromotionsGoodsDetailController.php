<?php
/**
 * OrderPromotionsGoodsDetailController
 * @author dev@xhat.com
 * @since 2020-03-10
 */
...
use App\Services\OrderPreSale\OrderPromotionsGoodsDetailService;


class OrderPromotionsGoodsDetailController extends CommonController
{
    protected $theService;

    public function __construct() {
        $this->theService = new OrderPromotionsGoodsDetailService();
        parent::__construct();
    }
