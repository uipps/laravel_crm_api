...
use App\Services\OrderPreSale\OrderAttachmentService;


class OrderAttachmentController extends CommonController
{
    protected $theService;

    public function __construct() {
        $this->theService = new OrderAttachmentService();
        parent::__construct();
    }
