<?php
/**
 * OrderPromotionsGroupController
 * @author dev@xhat.com
 * @since 2020-03-10
 */
...
use App\Services\OrderPreSale\OrderPromotionsGroupService;


class OrderPromotionsGroupController extends CommonController
{
    protected $theService;

    public function __construct() {
        $this->theService = new OrderPromotionsGroupService();
        parent::__construct();
    }
