...
class OrderRepeatController extends CommonController
{
    protected $theService;

    public function __construct() {
        $this->theService = new OrderRepeatService();
        parent::__construct();
    }
    ...
    public function getRepeatListById($id) {
        return $this->response_json($this->theService->getRepeatListById($id));
    }
