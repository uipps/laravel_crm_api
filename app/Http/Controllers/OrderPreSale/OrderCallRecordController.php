...
use App\Services\OrderPreSale\OrderCallRecordService;


class OrderCallRecordController extends CommonController
{
    protected $theService;

    public function __construct() {
        $this->theService = new OrderCallRecordService();
        parent::__construct();
    }
    ...
    public function callSomeBody() {
        return $this->response_json($this->theService->callSomeBody());
    }
