<?php
/**
 * OrderPromotionsDetailController
 * @author dev@xhat.com
 * @since 2020-03-10
 */
...
use App\Services\OrderPreSale\OrderPromotionsDetailService;


class OrderPromotionsDetailController extends CommonController
{
    protected $theService;

    public function __construct() {
        $this->theService = new OrderPromotionsDetailService();
        parent::__construct();
    }
