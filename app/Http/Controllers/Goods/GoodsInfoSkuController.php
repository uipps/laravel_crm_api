...
use App\Services\Goods\GoodsInfoSkuService;


class GoodsInfoSkuController extends CommonController
{
    protected $theService;

    public function __construct() {
        $this->theService = new GoodsInfoSkuService();
        parent::__construct();
    }
