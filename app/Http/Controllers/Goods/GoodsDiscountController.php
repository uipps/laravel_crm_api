...
use App\Services\Goods\GoodsDiscountService;


class GoodsDiscountController extends CommonController
{
    protected $theService;

    public function __construct() {
        $this->theService = new GoodsDiscountService();
        parent::__construct();
    }
