...
use App\Services\Admin\UserOrderInfoService;


class UserOrderInfoController extends CommonController
{
    protected $theService;

    public function __construct() {
        $this->theService = new UserOrderInfoService();
        parent::__construct();
    }
