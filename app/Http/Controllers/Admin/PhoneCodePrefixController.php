...
use App\Services\Admin\PhoneCodePrefixService;


class PhoneCodePrefixController extends CommonController
{
    protected $theService;

    public function __construct() {
        $this->theService = new PhoneCodePrefixService();
        parent::__construct();
    }
