...
use App\Services\Admin\PromotionsGoodsService;


class PromotionsGoodsController extends CommonController
{
    protected $theService;

    public function __construct() {
        $this->theService = new PromotionsGoodsService();
        parent::__construct();
    }
