<?php
/**
 * PromotionsGoodsNumRuleController
 * @author dev@xhat.com
 * @since 2020-03-10
 */
...
use App\Services\Admin\PromotionsGoodsNumRuleService;


class PromotionsGoodsNumRuleController extends CommonController
{
    protected $theService;

    public function __construct() {
        $this->theService = new PromotionsGoodsNumRuleService();
        parent::__construct();
    }
