...
use App\Services\Admin\UserLoginRecordService;


class UserLoginRecordController extends CommonController
{
    protected $theService;

    public function __construct() {
        $this->theService = new UserLoginRecordService();
        parent::__construct();
    }
