...
use App\Services\Admin\SysOptRecordService;


class SysOptRecordController extends CommonController
{
    protected $theService;

    public function __construct() {
        $this->theService = new SysOptRecordService();
        parent::__construct();
    }
