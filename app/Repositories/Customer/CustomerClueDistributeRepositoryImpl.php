...
use App\Models\Customer\CustomerClueDistribute;
use App\Repositories\BaseRepository;

class CustomerClueDistributeRepositoryImpl extends BaseRepository
{
    protected $model ;

    public function __construct() {
        $this->model = new CustomerClueDistribute();
    }
    ...
    public function insertMultiple($data_arr) {
