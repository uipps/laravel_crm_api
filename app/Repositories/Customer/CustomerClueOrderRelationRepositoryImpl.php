...
use App\Models\Customer\CustomerClueOrderRelation;
use App\Repositories\BaseRepository;

class CustomerClueOrderRelationRepositoryImpl extends BaseRepository
{
    protected $model ;

    public function __construct() {
        $this->model = new CustomerClueOrderRelation();
    }
