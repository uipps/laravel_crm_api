...
use App\Models\OrderPreSale\OrderPromotionsGoodsDetail;
use App\Repositories\BaseRepository;

class OrderPromotionsGoodsDetailRepositoryImpl extends BaseRepository
{
    protected $model ;

    public function __construct() {
        $this->model = new OrderPromotionsGoodsDetail();
    }
