...
class GoodsInfoSkuDto extends BaseDto
{
    public function Assign($items) {
        parent::Assign($items);
        if (isset($items['option_values']) && $items['option_values'] && '[]' != $items['option_values'])
    ...
    public $erp_product_id = 0;                 //  erp商品id
    ...
    public $sku = '';                           // SKU SPU+"-"+barcode_seri_no
    public $status = 0;                         // 商品状态 0关闭1开启
    public $option_values = [];                 // sku属性
