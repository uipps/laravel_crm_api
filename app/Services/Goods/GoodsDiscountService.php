...
use App\Dto\GoodsDiscountDto;
use App\Repositories\Goods\GoodsDiscountRepository;
use App\Repositories\Admin\UserRepository;
use App\Services\BaseService;
use Illuminate\Support\Facades\Validator;


class GoodsDiscountService extends BaseService
{
    protected $theRepository;

    public function __construct() {
        $this->theRepository = new GoodsDiscountRepository();
