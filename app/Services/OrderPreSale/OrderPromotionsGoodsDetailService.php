...
use App\Dto\OrderPromotionsGoodsDetailDto;
...
class OrderPromotionsGoodsDetailService extends BaseService
{
    protected $theRepository;

    public function __construct() {
        $this->theRepository = new OrderPromotionsGoodsDetailRepository();
    ...
    public function getList() {
        ...
        if ($list[$responseDto::DTO_FIELD_LIST]) {
            ...
            foreach ($list[$responseDto::DTO_FIELD_LIST] as $key => $v_detail) {
                $v_info = new OrderPromotionsGoodsDetailDto();
