...
use App\Dto\OrderAttachmentDto;
use App\Repositories\OrderPreSale\OrderAttachmentRepository;
use App\Repositories\Admin\UserRepository;
use App\Services\BaseService;
use Illuminate\Support\Facades\Validator;


class OrderAttachmentService extends BaseService
{
    protected $theRepository;

    public function __construct() {
        $this->theRepository = new OrderAttachmentRepository();
