...
class OrderInvalidService extends BaseService
{
    ...
    public function __construct() {
        $this->theRepository = new OrderInvalidRepository();
    ...
    private function getOneOrderInfo($v_detail, $order_info_list, $goods_info_list) {
        ...
        // DTO合并方法一，验证可行
        $v_info = array_merge((array)(new OrderInvalidDto()), (array)(new OrderDto()));
