...
use App\Dto\OrderRepeatKeyDto;
use App\Repositories\OrderPreSale\OrderRepeatKeyRepository;
use App\Repositories\Admin\UserRepository;
use App\Services\BaseService;
use Illuminate\Support\Facades\Validator;


class OrderRepeatKeyService extends BaseService
{
    protected $theRepository;

    public function __construct() {
        $this->theRepository = new OrderRepeatKeyRepository();
