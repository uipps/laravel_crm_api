...
use App\Dto\OrderPromotionsGroupDto;
use App\Repositories\OrderPreSale\OrderPromotionsGroupRepository;
use App\Repositories\Admin\UserRepository;
use App\Services\BaseService;
use Illuminate\Support\Facades\Validator;


class OrderPromotionsGroupService extends BaseService
{
    protected $theRepository;

    public function __construct() {
        $this->theRepository = new OrderPromotionsGroupRepository();
    ...
    public function getList() {
        ...
        if ($list[$responseDto::DTO_FIELD_LIST]) {
            ...
            foreach ($list[$responseDto::DTO_FIELD_LIST] as $key => $v_detail) {
                $v_info = new OrderPromotionsGroupDto();
