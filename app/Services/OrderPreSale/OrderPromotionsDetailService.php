...
use App\Dto\OrderPromotionsDetailDto;
use App\Repositories\OrderPreSale\OrderPromotionsDetailRepository;
use App\Repositories\Admin\UserRepository;
use App\Services\BaseService;
use Illuminate\Support\Facades\Validator;


class OrderPromotionsDetailService extends BaseService
{
    protected $theRepository;

    public function __construct() {
        $this->theRepository = new OrderPromotionsDetailRepository();
    ...
    public function getList() {
        ...
        if ($list[$responseDto::DTO_FIELD_LIST]) {
            ...
            foreach ($list[$responseDto::DTO_FIELD_LIST] as $key => $v_detail) {
                $v_info = new OrderPromotionsDetailDto();
