...
use App\Dto\OrderMsgRecordDto;
use App\Repositories\OrderPreSale\OrderMsgRecordRepository;
use App\Repositories\Admin\UserRepository;
use App\Services\BaseService;
use Illuminate\Support\Facades\Validator;


class OrderMsgRecordService extends BaseService
{
    protected $theRepository;

    public function __construct() {
        $this->theRepository = new OrderMsgRecordRepository();
