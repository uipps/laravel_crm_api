...
use App\Dto\CustomerClueDistributeDto;
...
class CustomerClueDistributeService extends BaseService
{
    protected $theRepository;

    public function __construct() {
        $this->theRepository = new CustomerClueDistributeRepository();
    ...
    public function getList() {
        ...
        if ($list[$responseDto::DTO_FIELD_LIST]) {
            ...
            foreach ($list[$responseDto::DTO_FIELD_LIST] as $key => $v_detail) {
                $v_info = new CustomerClueDistributeDto();
