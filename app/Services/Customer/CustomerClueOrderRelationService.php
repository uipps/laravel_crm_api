...
use App\Dto\CustomerClueOrderRelationDto;
use App\Repositories\Customer\CustomerClueOrderRelationRepository;
use App\Repositories\Admin\UserRepository;
use App\Services\BaseService;
use Illuminate\Support\Facades\Validator;


class CustomerClueOrderRelationService extends BaseService
{
    protected $theRepository;

    public function __construct() {
        $this->theRepository = new CustomerClueOrderRelationRepository();
    ...
    public function getList() {
        ...
        if ($list[$responseDto::DTO_FIELD_LIST]) {
            ...
            foreach ($list[$responseDto::DTO_FIELD_LIST] as $key => $v_detail) {
                $v_info = new CustomerClueOrderRelationDto();
