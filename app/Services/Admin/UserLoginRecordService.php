...
use App\Dto\UserLoginRecordDto;
...
class UserLoginRecordService extends BaseService
{
    protected $theRepository;

    public function __construct() {
        $this->theRepository = new UserLoginRecordRepository();
