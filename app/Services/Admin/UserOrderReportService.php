...
use App\Dto\UserOrderReportDto;
use App\Repositories\Admin\UserOrderReportRepository;
use App\Repositories\Admin\UserRepository;
use App\Services\BaseService;
use Illuminate\Support\Facades\Validator;


class UserOrderReportService extends BaseService
{
    protected $theRepository;

    public function __construct() {
        $this->theRepository = new UserOrderReportRepository();
