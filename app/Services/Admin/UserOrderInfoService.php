...
use App\Dto\UserOrderInfoDto;
use App\Repositories\Admin\UserOrderInfoRepository;
use App\Repositories\Admin\UserRepository;
use App\Services\BaseService;
use Illuminate\Support\Facades\Validator;


class UserOrderInfoService extends BaseService
{
    protected $theRepository;

    public function __construct() {
        $this->theRepository = new UserOrderInfoRepository();
