...
class SysConfigService extends BaseService
{
    ...
    public function __construct() {
        $this->theRepository = new SysConfigRepository();
    ...
    //
    public function getTimeoutInfo() {
        $request['id'] = 1; // 当前就只有一个配置，用于超时的
        $responseDto = new ResponseDto();
