...
use App\Dto\UserCustomerReportDto;
use App\Repositories\Admin\UserCustomerReportRepository;
use App\Repositories\Admin\UserRepository;
use App\Services\BaseService;
use Illuminate\Support\Facades\Validator;


class UserCustomerReportService extends BaseService
{
    protected $theRepository;

    public function __construct() {
        $this->theRepository = new UserCustomerReportRepository();
    ...
    public function getList() {
        ...
        if ($list[$responseDto::DTO_FIELD_LIST]) {
            ...
            foreach ($list[$responseDto::DTO_FIELD_LIST] as $key => $v_detail) {
                $v_info = new UserCustomerReportDto();
